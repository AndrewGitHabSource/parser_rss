...
Route::middleware('auth:sanctum')->prefix('admin')->group(function () {
    ...
    Route::get('/post/updatePost', [Controllers\Admin\PostController::class, 'getPost'])->name('admin.update.post');
    Route::get('/post/savePost', [Controllers\Admin\PostController::class, 'getPost'])->name('admin.save.post');
});
